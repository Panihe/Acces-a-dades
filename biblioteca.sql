...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2021 a las 21:14:09
...
CREATE TABLE `llibres` (
  ...
  `Any_naixement` char(4) DEFAULT NULL,
  `Any_publicacio` char(4) NOT NULL,
  `Editorial` varchar(50) NOT NULL,
  `Nombre_pagines` char(11) NOT NULL
...
INSERT INTO `llibres` (`Id`, `Titol`, `Autor`, `Any_naixement`, `Any_publicacio`, `Editorial`, `Nombre_pagines`) VALUES
